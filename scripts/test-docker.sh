...
echo ""
echo -e "  Windows: ${YELLOW}\\\\localhost\\[SHARE_NAME]${NC}"
echo -e "  Mac/Linux: ${YELLOW}smb://localhost/[SHARE_NAME]${NC}"
echo ""
echo -e "  ${GREEN}Note:${NC} Replace [SHARE_NAME] with the share name configured during setup (default: secure_share)"
echo ""
